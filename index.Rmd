...
Here are a few examples of filtering columns and rows using the Lahman database.Remeber you still need to first load the Lahman database, along with the package sqldf.
...
With SQL, you can order the rows of your output. For instnace, suppose you want to see every instance of a player hitting more than 50 homeruns. But you would like the players with the most homeruns to be at the top. We could do the following:
